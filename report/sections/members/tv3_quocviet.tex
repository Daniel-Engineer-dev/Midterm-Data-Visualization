...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/cust_spend_age_gender.png}
    \caption{Tổng chi tiêu theo nhóm tuổi và giới tính}
    \label{fig:cust_spend_age_gender}
\end{figure}

\textbf{7. Phân bổ khách hàng theo độ tuổi và giới tính --- Nhóm nào chi tiêu nhiều nhất?}
\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/cust_payment_heatmap.png}
    \caption{Heatmap tỉ lệ phương thức thanh toán theo nhóm tuổi (\%)}
    \label{fig:cust_payment_heatmap}
\end{figure}

\textbf{8. Phương thức thanh toán nào được ưa chuộng nhất? --- Có sự khác biệt theo nhóm tuổi không?}
\\
...
\begin{figure}[H]
    \centering
    \includegraphics[width=0.9\textwidth]{images/cust_top10.png}
    \caption{Top 10 khách hàng theo tổng chi tiêu tích lũy (USD)}
    \label{fig:cust_top10}
\end{figure}

\textbf{9. Top khách hàng có giá trị cao nhất (theo tổng chi tiêu) là ai?}
\\
